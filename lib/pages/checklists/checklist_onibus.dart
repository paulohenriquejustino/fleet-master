...
Future<bool> verificarSeChecklistJaExiste(String placa) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Checklist de Onibus'),
        centerTitle: true,
      ),
      body: Column(
        children: [
...
Future<void> addChecklistToFirebase(
  ...
  final checklistOnibus =
      FirebaseFirestore.instance.collection('checklist_onibus');
...
Future<void> updateCarStatus(String placa) async {
  ...
  final veiculosCollection =
      FirebaseFirestore.instance.collection('cadastro_onibus');
