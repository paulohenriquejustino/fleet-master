...
Future<bool> verificarSeChecklistJaExiste(String placa) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Checklist de Vans'),
        centerTitle: true,
      ),
      body: Column(
        children: [
...
Future<void> addChecklistToFirebase(
  ...
  final checklistVan =
      FirebaseFirestore.instance.collection('checklist_van');
